...
function TOS() {
  return (
    <div style={styles.container}>
      ...
      <p>
        By visiting this website, you agree that the laws of the [your location], without regard
        to principles of conflict laws, will govern these terms of service, or any dispute of any
        sort that might come between [name] and you, or its business partners and associates.
      </p>
      ...
      <p>
        ...
        to use, reproduce, publish, modify such content throughout the world in any media.
      </p>
